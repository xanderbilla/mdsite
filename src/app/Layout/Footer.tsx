...
export default function Footer({}: Props) {
  ...
  return (
    <div className="w-full h-32 tablet:h-24 px-4 tablet:px-8 laptop:px-16 flex flex-col tablet:flex-row items-center 
    justify-between py-4 gap-4 bg-gradient-to-t from-slate-300 via-slate-200/90 to-slate-100/30">
      ...
      <div className="h-auto flex flex-col items-center justify-center gap-1">
        <h3 className="text-lg tablet:text-2xl">mdsite Template</h3>
